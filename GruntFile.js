const updateBoxes = require('./scripts/modelsUpdate');
const separateWindowIds = require('./scripts/separateWindowIds');
const clearAssets = require('./scripts/clearAssets');
...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        eslint: {
            target: ['**/*.js', '!node_modules/**', '!www/**', '!hookServer/**', '!build/**']
        }
    });
    ...
    grunt.registerTask('update-boxes', 'Updating boxes', function () {
        updateBoxes(this.async());
    });
    grunt.registerTask('separate-window-ids', 'Updating boxes', function () {
        separateWindowIds(this.async());
    });
    grunt.registerTask('assets-clear', 'Updating assets / Removing unused models', function () {
        clearAssets(this.async());
    });
};
