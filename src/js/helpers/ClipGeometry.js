...
class ClipGeometry extends THREE.BufferGeometry {
    ...
    constructor(planeGeometry) {
        ...
        /**
         * Copies clip areas in to target geometry
         * @param geometry Geometry to copy clip areas from
         * @returns {ClipGeometry} Target geometry
         */
        function clipCopy(geometry) {
            clipRects_ = geometry.clip.rectangles;
            generateGeometry();
