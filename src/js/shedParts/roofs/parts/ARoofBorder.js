...
class ARoofBorder extends THREE.Object3D {
    ...
    constructor(roofVertices, shedWidth, shedDepth, roofHeight, aWidth = tools.in2cm(4.5), aHeight = tools.in2cm(3.1875)) {
        ...
        let wallExtendingVertices = [
            roofVertices[0] + aWidth, 0, shedDepth * 0.5, // 0
            roofVertices[6] - aWidth, 0, -shedDepth * 0.5, // 1
            roofVertices[9] + aWidth, 0, -shedDepth * 0.5, // 2
            roofVertices[15] - aWidth, 0, shedDepth * 0.5, // 3
            roofVertices[0] + aWidth, wallHeightEnd, shedDepth * 0.5, // 4
            roofVertices[6] - aWidth, wallHeightEnd, -shedDepth * 0.5, // 5
            roofVertices[9] + aWidth, wallHeightEnd, -shedDepth * 0.5, // 6
            roofVertices[15] - aWidth, wallHeightEnd, shedDepth * 0.5 // 7
        ];
