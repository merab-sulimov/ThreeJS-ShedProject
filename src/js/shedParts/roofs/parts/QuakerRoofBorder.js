...
class QuakerBorder extends THREE.Object3D {
    ...
    constructor(roofVertices, shedWidth, shedDepth, roofHeight, isReversed = false) {
        ...
        let dashParameters = {
            vertices: [
                -shedWidth * 0.5 - tools.ft2cm(1.5), 0, shedDepth * 0.5, // 0
                ...
                shedWidth * 0.5 + in4p5, 0, shedDepth * 0.5, // 5
                shedWidth * 0.5 + in4p5, 0, shedDepth * 0.5, // 6
                shedWidth * 0.5 + in4p5, aHeight, shedDepth * 0.5 // 7
            ],
            indices: [
                // 0, 8, 1,
                // 8, 9, 1,
