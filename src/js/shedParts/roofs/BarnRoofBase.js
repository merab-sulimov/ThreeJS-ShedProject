...
/**
 * Base class for Barn Roof 3D object.
 * @author Yevhen Petrashchuk a.k.a Vaper de kin 2017
 * @author Sharpov Sergey 2018
 */
class BarnRoofBase extends Roof {
    /**
     * Creates roof object
     * @param shedWidth Shed's width
     * @param shedDepth Shed's depth
     * @param roofHeight Height of the roof
     * @param vertices Array of roof vertices
     * @param wPadding Width padding of the roof
     * @param dPadding Depth padding of the roof
     */
    constructor(shedWidth, shedDepth, roofHeight, vertices, wPadding = 10.0, dPadding = 12.7, environmentCamera, hasMetalBorder = true) {
        let planes_ = [];
        ...
        let diagonal = Math.sqrt(2 * Math.pow(wPadding, 2));

        let shingleObjects_ = [];
        let metalObjects_ = [];

        let vertices_ = _.clone(vertices);
        ...
        let trim2 = new SimpleTrim(tools.in2cm(4), shedDepth + dPadding * 2, trimAngle1, trimAngle2);
        ...
        let trim3 = new SimpleTrim(tools.in2cm(4), shedDepth + dPadding * 2, trimAngle2, trimAngle1);
